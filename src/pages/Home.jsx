...
function ExpertiseCard({ item, index, t }) {
  ...
  return (
    <div className="expertise-card group relative bg-[#12367e]/[0.07] rounded-3xl overflow-hidden border border-[#12367e]/[0.15] hover:shadow-2xl hover:shadow-[#12367e]/[0.12] cursor-pointer">
...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-[#f5f5f7]">
      ...
      {/* EXPERTISE */}
      <section ref={expertiseRef} id="services" className="py-16 sm:py-24">
